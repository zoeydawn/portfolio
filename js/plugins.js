...
(function($) {
	...
	$("#facts").appear(function() {
		$("#number_1").animateNumber({
			number: 64	// Change to your number
		}, 2200);
		$("#number_2").animateNumber({
			number: 6281		// Change to your number
		}, 2200);
		$("#number_3").animateNumber({
			number: 427		// Change to your number
		}, 2200);
		$("#number_4").animateNumber({
			number: 12180160		// Change to your number
		}, 2200);
	}, {
		accX: 0,
		accY: -150
	...
	$("#skills").appear(function() {
		...
		$("#chart_num_4").animateNumber({
			number: 92		// Change to your number
		}, 1500);
	}, {
		accX: 0,
		accY: -150
